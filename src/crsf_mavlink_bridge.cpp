...
void CRSFMavlinkBridge::SendHeartbeat(MAVLink &mavlink)
{
...
void CRSFMavlinkBridge::SendGpsRawInt(MAVLink &mavlink, int32_t lat, int32_t lon, int32_t alt,
...
void CRSFMavlinkBridge::SendGlobalPositionInt(MAVLink &mavlink, int32_t lat, int32_t lon,
...
void CRSFMavlinkBridge::SendMavlinkMessage(MAVLink &mavlink, mavlink_message_t &msg)
{
